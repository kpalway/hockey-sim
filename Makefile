...
TARGET = hockey-sim
OFILES = main.o Player.o PlayerDatabase.o Team.o TeamDatabase.o IndividualStats.o OnIceStats.o BioStats.o CSV.o Game.o Event.o ShotAttempt.o Shot.o Goal.o PeriodEnd.o LineChange.o Penalty.o Simulator.o Replacement.o PenaltyEnd.o
